...
const FooterContainer = styled.footer`
  display: grid;
  grid-template-columns: 1.93fr minmax(204px, 1fr) minmax(204px, 1fr);
  background-color: #ffffff;
  background-size: 100%;
  padding: 54px 0 40px 57px;
`;
